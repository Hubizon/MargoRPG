...
public class TinyDB {
    ...
    public ArrayList<Item> getListObject(String key, Class<?> mClass){
    	Gson gson = new Gson();
    	...
    	for(String jObjString : objStrings){
            Item value  = (Item) gson.fromJson(jObjString,  mClass);
    		objects.add(value);
    	}
    	return objects;
    }
    ...
    public <T> T getObject(String key, Item DefaultValue){
        if(key == "armor")
        {
            Gson gson = new Gson();

            String json = getString(key, gson.toJson(DefaultValue));
            Object value = new Gson().fromJson(json, Item.class);
    ...
    public void putListObject(String key, ArrayList<Item> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
